...
onEvent('tags.items', e =>{
    e.add("mysticalagriculture:essences/elemental",[
        'mysticalagriculture:mgaic_seeds','mysticalagriculture:mgaic_essence',
        'mysticalagriculture:air_seeds','mysticalagriculture:air_essence',
        'mysticalagriculture:earth_seeds','mysticalagriculture:earth_essence',
